 ...
 * @copyright 2024
 *
 * This file declares a ROS2 publisher node that publishes customizable string
 * messages at a configurable frequency and provides a service to modify the
 * message content.
 */
...
class MinimalPublisher : public rclcpp::Node {
 ...
 private:
   ...
   *
   * @param request Shared pointer to the service request containing a boolean
   * flag
  ...
  rclcpp::Publisher<std_msgs::msg::String>::SharedPtr
      publisher_;  ///< String message publisher
  rclcpp::Service<example_interfaces::srv::SetBool>::SharedPtr
      service_;               ///< Service to modify message
